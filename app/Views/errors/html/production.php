...
<head>
    <meta charset="utf-8">
    <title>Something Went Wrong — Photos</title>
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">
            We've encountered an unexpected error while processing your request. Our team has been notified and we're working to fix it.
        </p>
